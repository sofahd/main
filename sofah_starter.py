...
class SofahStarter:
    ...
    def __init__(self, log_folder_path:str, endpoint_path:str, ip_address:str, work_folder:str, placeholder_vars:dict, project_name:str = "sofah") -> None:
        """
        ...
        self.log_api_service = LogApiService(log_folder_path=self.log_folder_path, name="log_api", port=50005, token=None)
    ...
    def first_stage(self) -> None:
        ...
        recon_service = ReconService(name="recon",endpoints=json.loads(open(self.endpoint_path).read()), ip_adresses=[self.ip_address],log_api_url="http://log_api:50005", token=None, log_container_name="log_api")
    ...
    def second_stage(self) -> None:
        ...
        ennorm_service = EnnormService(ip=self.ip_address, log_api_url="http://log_api:50005", token=None, log_container_name="log_api", name="ennorm", placeholder_vars=self.placeholder_vars)
...
if __name__ == "__main__":
    ...
    starter = SofahStarter(log_folder_path=log_folder_path, endpoint_path=endpoint_path, ip_address=ip_address, work_folder=work_folder, placeholder_vars=placeholder_vars, project_name=project_name)
    starter.main()
